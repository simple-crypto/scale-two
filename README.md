...
1. [Download](https://enigma.elen.ucl.ac.be/dsm/sharing/5Ecvmqh2e) the datasets and unzip it into a directory `scale2-ds` located at the root of the repo. In particular you will find several datasets that are stored per session, and in several files (in order to ease the download).
